...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        livingGhostPositionDistributions = [beliefs for i, beliefs in enumerate(self.ghostBeliefs) if livingGhosts[i+1]]        #get all the living ghosts as per pacman's beliefs
        "*** YOUR CODE HERE ***"

        bestAction = None               #set best action
        bestActionDist = None
        mostLikelyGhostPostition = []
        ...
        for dist in livingGhostPositionDistributions:       #iterate over living ghosts distribution
            ...
            mostLikelyGhostPostition.append(mostLikelyPos)      #accumulate all the positions


        for ghostPosition in mostLikelyGhostPostition:          #iterate over mostly likely ghost positions
