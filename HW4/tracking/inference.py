...
class ExactInference(InferenceModule):
    ...
    def observe(self, observation, gameState):
        ...
        if noisyDistance is not None:           #if sonar data available
            ...
            jailP = self.getJailPosition()      #identify the eaten ghost's position
            allPossible[jailP] = 1.0            #mark as consumed
        ...
        *** GORY DETAIL AHEAD ***
        ...
        for oldPos in self.legalPositions:
            ...
            for newPos, possibility in newPosDist.items():
                ...
                newPossibility = possibility * self.beliefs[oldPos]     #calculate the new probalility of ghosts position
